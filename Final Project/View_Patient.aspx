<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View_Patient.aspx.cs" Inherits="Final_Project.View_Patient" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="middle">
            ...
            <div class="inner-header" style="text-align: center">
                <asp:Label ID="Label1" runat="server" Text="View or Modify Patient Details" Font-Bold="True"></asp:Label>
            </div>
            ...
            <div style="text-align:center">
                ...
                <div class="add_buttons">
                    ...
                    <asp:Button ID="updatePatientDetails" runat="server" Text="Update Details" Height="37px" Width="125px" OnClick="updatePatientDetails_Click"/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="clearDetails" runat="server" Text="Clear" Height="37px" Width="125px" OnClick="clearDetails_Click" />
                    <br />
                    <br />
                    <asp:Label ID="updationOutcome" runat="server"></asp:Label>
                </div>
